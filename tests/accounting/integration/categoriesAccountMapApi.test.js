...
describe('Category Account Map API', () => {
  runExtendedCrudTests({
    ...
    beforeHook: async ctx => {
      ...
      await db.none(
        `INSERT INTO tenantid.categories (tenant_id, category_id, name, created_by) VALUES ($1, $2, $3, $4)`,
        [ctx.tenantId, ctx.categoryId, 'Materials', 'integration-test']
      );

      await db.none(
        `INSERT INTO tenantid.chart_of_accounts (tenant_id, id, code, name, type, is_active, cash_basis, created_by) VALUES ($1, $2, $3, $4, $5, true, false, $6)`,
