...
db.interCompanyAccounts = {
  insert: jest.fn().mockResolvedValue({ id: mockId, name: 'Test Account' }),
...
runControllerCrudUnitTests({
  ...
  controller: InterCompanyAccountsController,
  modelName: 'interCompanyAccounts',
  db,
});