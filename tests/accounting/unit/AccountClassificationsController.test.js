...
db.accountClassifications = {
  insert: jest.fn().mockResolvedValue({ id: mockId, name: 'Test Classification' }),
...
runControllerCrudUnitTests({
  ...
  controller: AccountClassificationsController,
  modelName: 'accountClassifications',
  db,
});