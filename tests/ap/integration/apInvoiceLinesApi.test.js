...
describe('AP Invoice Lines API', () => {
  runExtendedCrudTests({
    ...
    beforeHook: async ctx => {
      ...
      await db.none(
        `INSERT INTO tenantid.chart_of_accounts (id, tenant_id, code, name, created_by) VALUES ($1, $2, $3, $4, $5)`,
        [ctx.accountId, ctx.tenantId, '5100', 'Job Costs', 'integration-test']
      );

      await db.none(
        `INSERT INTO tenantid.activities (id, tenant_id, activity_code, name, created_by) VALUES ($1, $2, $3, $4, $5)`,
